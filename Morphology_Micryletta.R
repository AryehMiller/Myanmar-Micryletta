## Micryletta Morphological Analysis
## Checked by Aryeh H. Miller on 4 February 2021
...
dataraw<- read.csv(file = "4Feb21_SupplementalTable2_MicrylettaMature.csv")
...
TlogFemaleInterOrb <- log(MatureFemales$IntOrb)
...
datameasurementsFemales = droplevels(subset(MatureFemales, select=c(Museum, Species,Country,Province,	Latitude,	Longitude,Sex,Mature,HeadL,	HeadWP, SnEye,	NarEye,	EyeD,	IntOrb,	IntNar,	SVL,	TrunkL,	ForarmL,	HandL,	ThreeFingL,	ThighL,	CrusL,	TarsL,	FootL,	HindlL,	FourToeL)))
...
TlogMaleInterOrb <- log(MatureMales$IntOrb)
...
datameasurementsMales = droplevels(subset(MatureMales, select=c(Museum, Species,Country,Province,	Latitude,	Longitude,	Sex,	Mature,HeadL,	HeadWP, SnEye,	NarEye,	EyeD,	IntOrb,	IntNar,	SVL,	TrunkL,	ForarmL,	HandL,	ThreeFingL,	ThighL,	CrusL,	TarsL,	FootL,	HindlL,	FourToeL)))
